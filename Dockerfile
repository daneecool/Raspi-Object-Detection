...
# Ensure critical packages are present (fallback) - helps if requirements change or pip caching issues
RUN pip3 install --no-cache-dir ultralytics opencv-python numpy --upgrade || true
